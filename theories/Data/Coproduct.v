...
Proof.
  intros A B cp.
  match cp with | a | b end; simpl in |- *; reflexivity.
Qed.
...
Module right. (* mapping.right *)

(* mapping.right.identity *)
Theorem identity
